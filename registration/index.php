<!--
File Name: index.php - Registration Form
Date: 02/28/19
...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <form class="contact-form" action="regform.php" method="post">
                <div class="row">
                    <div class="col-75">
                ...
                <div class="row">
                    <br>
                    <div class="col-75">
                        <input type="text" id="emergencyPhone" name="emergencyPhone" placeholder="Emergency Contact Phone #">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="subject">Saturday</label>
                    </div>
                    <div class="col-75">
                        <input type="radio" name="event" value="Long Course"> Long Course<br>
                        <input type="radio" name="event" value="Olympic"> Olympic<br>
                        <input type="radio" name="event" value="10K"> 10K<br>
                        <input type="radio" name="event" value="Half Marathon"> Half Marathon<br>
                    </div>
                </div>
                <div class="row">

                    <div class="col-25">
                        <label for="subject">Sunday</label>
                    </div>
                    <div class="col-75">
                        <input type="radio" name="event" value="Sprint"> Sprint<br>
                        <input type="radio" name="event" value="Try-a-Tri"> Try-a-Tri<br>
                        <input type="radio" name="event" value="Splash-n-Dash"> Splash-n-Dash<br>
                    </div>
                </div>
                ...
                <div class="row">
                    <br>
                    <div class="col-75">
                        <textarea id="accommodations" name="accommodations" placeholder="Any Special Accommodations" style="height:200px"></textarea>
                    </div>
                </div>
                <div class="row">
                    <br>
